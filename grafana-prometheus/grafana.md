...
Чтобы это сделать, в Longhorn нужно запустить Trim FileSystem на volume prometheus. Также можно настроить recurring job, чтобы это происходило по cron расписанию.
